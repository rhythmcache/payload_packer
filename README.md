...
This is an experimental tool. The official Google delta generator may use different methods and optimisations. Use this tool at your own risk for development and testing purposes. The payloads generated by this tool have not yet been tested on real devices. However, they have been successfully validated using multiple third-party payload dumpers, including:
- [vm03/payload_dumper](https://github.com/vm03/payload_dumper) (Python)
- [rhythmcache/payload-dumper-rust](https://github.com/rhythmcache/payload-dumper-rust)
- [ssut/payload-dumper-go](https://github.com/ssut/payload-dumper-go)

All of the above tools were able to correctly interpret and extract payloads generated by this tool, with bit-for-bit matching partition hashes.
